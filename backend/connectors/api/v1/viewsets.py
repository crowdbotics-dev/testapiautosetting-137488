...
class Testconnectors137488ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137488_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137488_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137488"
